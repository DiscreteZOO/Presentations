...
%% Ensure copy-pasteable č in the resulting pdf
%% See https://tex.stackexchange.com/a/239177/
%
...
\frame
{
    ...
    \newblock {\em J. Graph Theory}, 86(4):406--421, 2017.

    \bibitem{pv5} P.~Potočnik and J.~Vidali.
    \newblock Cubic girth-regular graphs of small girth.
    \newblock Submitted to {\em Ars Math. Contemp.}

    \bibitem{pv6} P.~Potočnik and J.~Vidali.
